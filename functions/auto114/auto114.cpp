...
void auto114::process(shinx_message msg)
{
    ...
    setlog(LOG::INFO, "auto114 at group " + std::to_string(msg.group_id) +
                          " by user " + std::to_string(msg.user_id));
    if (input == 114514) {
...
bool auto114::check(shinx_message msg) { return msg.message.find("homo") == 0; }
