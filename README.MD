...
需要几个支持库：[cpp-httplib](https://github.com/yhirose/cpp-httplib) + openssl-dev / [jsoncpp](https://github.com/open-source-parsers/jsoncpp) / [CImg](https://www.cimg.eu/) / [base64](https://github.com/tobiaslocker/base64)
